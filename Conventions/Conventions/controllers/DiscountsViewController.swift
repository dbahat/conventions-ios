...
class ActivitiesViewController : DiscountsAndActivitiesViewController {
    override func viewDidLoad() {
        ...
        items = [
            Item(text: "מסלולי תוכן<br/>תוכניית הפסטיבל ענקית, מופלאה ועמוסה בכל טוב!<br/>כדי לעזור לך בהתמצאות הכנו מפת שבילים מומלצים לכל יום שיאפשרו לך להנות מכל מה שיש לפסטיבל להציע בנחת ובכיף. אפשר למצוא את ההמלצות בקלות על ידי לחיצה על שם התגית.<br/>יום שלישי 29.9.26<br/>שביל טעימה מאייקון<br/>שביל מסביב לעולם<br/>יום רביעי 30.9.26<br/>שביל רומנטזי<br/>השביל הפעיל<br/>יום חמישי 1.10.26<br/>שביל עומק<br/>שביל ילדים ונוער<br/>מסלולי משחקי תפקידים<br/>שביל משחקי תפקידים - עיוני<br/>שביל משחקי תפקידים - לילדים<br/>שביל משחקי תפקידים - לנוער<br/>שביל משחקי תפקידים - ערפדים<br/>שביל משחקי תפקידים - אייקון אחרי העבודה"),

            Item(text: "קלפי רוחות ערים<br/>אספו את כולם!<br/>קלפי הדמויות של הפקת המקור \"רוחות הערים עושות סדר\" מחכים ברחבי הפסטיבל! קבלו את הקלף הראשון בדוכן האגודה ועקבו אחרי ההוראות כדי להשלים את כל האוסף!<br/>פרטים נוספים בדוכן האגודה ובמודיעין",
                 image: UIImage(named: "icon2026_activities_city_spirits_cards")),

            Item(text: "מרחב בריחה בפסטיבל: סוד הפלאות<br/>היכונו להרפתקה! סוד הפלאות, מרחב חידות חוויתי ברחבי הכנס. בכל שעות היום וללא עלות, התחילו כאן או גשו לדוכן המודיעין וסרקו את הקוד על מנת להתחיל במסע<br/>כבר מספר שבועות שאנחנו בא.ל.י.ס. עוקבים אחר \"הארנב הלבן\", כנופיית ההאקרים הידועה לשמצה. הארנב הלבן טוענים שהנהלת אייקון מסתירה מידע על קיומם של חייזרים, יקומים מקבילים, ושלל עולמות פנטסטיים. אנחנו לא יכולים לאשר או להכחיש את הטענות, אך כך או כך אסור לנו לתת לארנב הלבן להפיל את אייקון. אנו זקוקים לצוות הטוב ביותר, האם תתגייסו למשימה?",
                 image: UIImage(named: "icon2026_activities_secret_of_wonders")),

            Item(text: "הבוטיק בדיזנגוף סנטר הופך למתחם מנוחה וכיף!<br/>קומה 1- במעבר ליד הסופר פארם<br/>כל ימי הפסטיבל בין השעות 13:00-19:00<br/>מתחם מנוחה על ספות כורסאות ופופים<br/>סרט קולנוע בשעה 16:00 בכל יום<br/>29.9 הסיפור שאינו נגמר<br/>30.9 פרסי ג'קסון<br/>1.10 הוקוס פוקוס<br/>פופקורן חינם ועוד הפתעות!<br/>בנוסף יוקרנו בכל יום פרקים מהסדרה בוב ספוג<br/>בואו לנוח במזגן ולחזור לפסטיבל בכוחות מחודשים!",
                 image: UIImage(named: "icon2026_sponsors_center")),

            Item(text: "מתחם משחקי מחשב<br/>מתחם משחקי אינדי ישראלים!<br/>כמו בכל שנה בשנים האחרונות מוזמנות ומוזמנים למתחם הגיימינג בו תוכלו לשחק במשחקים ישראלים חדשים, לפגוש את המפתחים ולהשאיר רשמים וביקורות!"),

            Item(text: "חנות המשחקים הגדולה של ירושלים<br/>הדגמות משחקים לאורך כל הפסטיבל<br/>מתחם משחקי הלוח בסינמטק",
                 image: UIImage(named: "icon2026_sponsors_sirolynia"),
                 linkText: "סירולניה",
                 linkUrl: "https://sirolynia.com/il"),

            Item(text: "קרן השפע באייקון!<br/>חברת משחקי התפקידים הותיקה מגיעה להרפתקאות מופלאות בפסטיבל<br/>סיפור הרפתקאות<br/>חרבות וכשפים במולאר<br/>מהרו להזמין כרטיסים, המלאי מוגבל!",
                 image: UIImage(named: "icon2026_sponsors_keren_hashefa"),
                 linkText: "קרן השפע",
                 linkUrl: "https://xn----8hc5aojohl.co.il/"),
        ]

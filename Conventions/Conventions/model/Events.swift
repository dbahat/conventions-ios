...
class Events {
    private static let eventsApiUrl = URL(string: "https://api.sf-f.org.il/program/list_events.php?slug="+Convention.slug)!;
    private static let availableTicketsCacheLastRefreshTimeApi = URL(string: "https://api.sf-f.org.il/program/cache_get_last_updated.php?which=available_tickets&slug="+Convention.slug)!

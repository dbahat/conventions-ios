...
class Events {
    private static let eventsApiUrl = URL(string: "https://api.sf-f.org.il/program/list_events.php?slug=icon2018")!;
    private static let availableTicketsCacheLastRefreshTimeApi = URL(string: "https://api.sf-f.org.il/program/cache_get_last_updated.php?slug=icon2018&which=available_tickets")!

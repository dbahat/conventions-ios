...
class Convention {
    ...
    static let date = Date.from(year: 2023, month: 10, day: 3)
    static let endDate = Date.from(year: 2023, month: 10, day: 5)
    static let name = "icon2023"
    static let displayName = "פסטיבל אייקון 2023"

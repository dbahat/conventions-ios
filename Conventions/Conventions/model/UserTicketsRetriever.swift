...
class UserTicketsRetriever {
    ...
    func retrieve(caller: UIViewController, callback: ((_ result: Tickets, _ error: Error?) -> Void)?) {
        ...
        OIDAuthorizationService.discoverConfiguration(forIssuer: issuer) { configuration, error in
            ...
            appDelegate.currentAuthorizationFlow = OIDAuthState.authState(byPresenting: request, presenting: caller) { authState, error in
                ...
                self.sendRequest(url: UserTicketsRetriever.userTicketsApi, method: "GET", token: tokenResponse.accessToken, body: nil, completionHandler: { (data, error) in
                    guard
                    ...
                    self.sendRequest(url: UserTicketsRetriever.userIdApi, method: "GET", token: tokenResponse.accessToken, body: nil, completionHandler: { (data, error) in
                        guard
                            let unwrappedData = data,
